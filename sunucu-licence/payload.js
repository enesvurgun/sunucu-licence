(function() {
    ...
    // ================================================================
    // === 1. GÜVENLİK KONTROLLERİ (Script'in en başında çalışır) ===
    // ================================================================

    // --- Anti-Debugging Koruması ---
    // Birisi F12'yi açıp kodu incelemeye çalıştığında sekmeyi dondurur.
    ...
    // --- Tarih Kilitleme Koruması ---
    // Eklentinin bu tarihten sonra çalışmamasını sağlar.
    const expirationDate = new Date('2026-12-31'); // <-- BU TARİHİ İSTEDİĞİN GİBİ DEĞİŞTİR
    if (new Date() > expirationDate) {
        return; 
    }
    
    // ================================================================
    // === 2. ANA OYUN SCRIPTI (TÜM KODLAR DAHİL) ===
    // ================================================================
    function initializeScript() {
        console.log("Lisanslı script başarıyla çalıştırıldı.");
        
        // --- SENİN OYUN KODLARIN BURADAN BAŞLIYOR ---

        // Butonun oluşturulması
        ...
        // Eğer buton zaten varsa, eskisini kaldırıp yenisini ekle (güncellemeler için)
        ...
        async function sendArmyMoveRequest() {
            ...
            try {
                ...
                console.error("❌ Ordu taşıma isteği sırasında bir hata oluştu:", error);
            }
        }
